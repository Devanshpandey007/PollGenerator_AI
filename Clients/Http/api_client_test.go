...
// func TestMakeGetRequest_ReadBodyError(t *testing.T) {
// 	ctx := context.Background()
// 	mockClient := new(MockHTTPClient)

// 	// Create a mock response with a broken body reader
// 	mockResp := &http.Response{
// 		StatusCode: http.StatusOK,
// 		Body:       ioutil.NopCloser(&errorReader{}), // Reader that returns an error
// 	}
...
// Helper struct to simulate a failing reader
